...
def load_accepted_bot_list(file_path):
...
accepted_bots = load_accepted_bot_list('MatchStarter/bots.json')['bots']

bots = [bot for bot in bots if bot['name'] in accepted_bots]


bot_list = []
bot_1 = bots[0]
bot_list.append({'name': 'test_custom_name', 'team': 0, 'type': 'rlbot', 'skill': 1, 'path': bot_1['path']})

bot_2 = bots[1]
bot_list.append({'name': 'test_custom_name', 'team': 1, 'type': 'rlbot', 'skill': 1, 'path': bot_2['path']})
